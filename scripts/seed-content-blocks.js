...
const contentBlocks = [
  ...
  { page: 'about', section: 'hero', block_type: 'image', block_key: 'background', content: JSON.stringify({ src: "/images/team.jpg", alt: "ESHRM Team Collaboration" }), sort_order: 4 },
  ...
  { page: 'about', section: 'story', block_type: 'image', block_key: 'story_image', content: JSON.stringify({ src: "/images/team.jpg", alt: "ESHRM Team Collaboration" }), sort_order: 5 },
  ...
  { page: 'about', section: 'africa_focus', block_type: 'image', block_key: 'image', content: JSON.stringify({ src: "/images/digital.jpg", alt: "ESHRM Africa Coverage" }), sort_order: 5 },
