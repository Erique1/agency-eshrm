...
export function FAQSection() {
  ...
  const defaultFaqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "Absolutely. We have expertise in labor laws and HR regulations across 2+ African Countries. We help organizations navigate complex multi-country compliance requirements while maintaining consistent HR practices.",
    },
    {
